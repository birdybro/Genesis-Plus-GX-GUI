...
struct DiagnosticsSnapshot final {
  ...
  std::string inputMovieState;
  std::uint64_t inputMovieFrame{0U};
  std::uint64_t inputMovieFrameCount{0U};
  std::uint64_t inputMovieRerecordCount{0U};
  bool streamingActive{false};
  std::uint16_t streamingPort{0U};
  std::size_t streamingClients{0U};
  std::size_t streamingQueuedFrames{0U};
  std::size_t streamingQueueCapacity{0U};
  std::uint64_t streamingBroadcastFrames{0U};
  std::uint64_t streamingDroppedFrames{0U};
  std::uint64_t streamingSlowClientDisconnects{0U};
  std::uint64_t streamingBytesSent{0U};
