...
constexpr std::array hotkeyDescriptions{
  ...
  HotkeyDescription{input::EmulatorHotkeyAction::slowMotionHold,
    "Slow motion (hold)", "SlowMotionHold"},
  HotkeyDescription{input::EmulatorHotkeyAction::slowMotionToggle,
    "Slow motion (toggle)", "SlowMotionToggle"},
