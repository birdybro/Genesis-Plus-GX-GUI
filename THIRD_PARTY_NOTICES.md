...
| [Qt 6](https://doc.qt.io/qt-6/licensing.html) | Core, GUI, Widgets, OpenGLWidgets, SQL/SQLite, Test framework, and Linguist catalog tools | Minimum 6.8; hosted builds use 6.8.3; dynamically deployed desktop modules/plugins | GNU LGPL v3 or GPL v3 open-source editions, or a separately purchased commercial license, as offered by The Qt Company |
